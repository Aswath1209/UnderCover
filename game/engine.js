...
function calculateBallOutcome(
  ...
  if (shotHistory.length >= 2) {
    ...
    if (shot === lastShot && shot === secondLastShot) {
      shotSpamWicketMult = 2.2;
      shotSpamRunMult = 0.5;
    } else if (shot === lastShot) {
      shotSpamWicketMult = 1.5;
      shotSpamRunMult = 0.75;
    }
  }
  ...
  let wicketChance = baseWicketProb * (1 + (0.6 - successValue)) * speedWicketMult * pitchWicketMult * shotSpamWicketMult * momentumWicketMult;
